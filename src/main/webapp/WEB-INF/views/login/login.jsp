        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form:form modelAttribute="loginForm" servletRelativeAction="/processLogin" method="post">
              <h1>Login Form</h1>
              <div>
                <form:input path="userName" type="text" cssClass="form-control" placeholder="Username" required="" />
                <div class="has-error">
                	<form:errors path="userName" cssClass="help-block"></form:errors>
                </div>
              </div>
              <div>
                <form:input path="password" type="password" cssClass="form-control" placeholder="Password" required="" />
                <div class="has-error">
